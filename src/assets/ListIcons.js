...
const ListIcons = ({
  ...
  if(name === "Clipboard"){
    return (
    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-clipboard2-pulse" viewBox="0 0 16 16">
  ...
  if(name === 'help'){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-question-square" viewBox="0 0 16 16">
  ...
  if(name === 'filter'){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-funnel-fill" viewBox="0 0 16 16">
